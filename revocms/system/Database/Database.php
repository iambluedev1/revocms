...
class Database extends PDO
{
    ...
    public static function get(bool $group = false) : Database
    {
        ...
        $group = !$group ? array(
            'type' => $rcms->configs->database->get("DB_TYPE"),
            'host' => $rcms->configs->database->get("DB_HOST"),
            'name' => $rcms->configs->database->get("DB_NAME"),
            'user' => $rcms->configs->database->get("DB_USER"),
            'pass' => $rcms->configs->database->get("DB_PASS")
        ) : $group;
